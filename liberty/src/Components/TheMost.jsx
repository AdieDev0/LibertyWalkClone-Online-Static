      ...
      <Marquee pauseOnHover direction="right">
        <div className="flex gap-2">
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">CHEVROLET</p>
                <p>LB E★Silhouette WORKS Chevrolet Corvette C8 Body Kit</p>
              </div>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">BMW</p>
                <p>LB E★Works BMW M3 Ver.2 Wing (E92)</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$1,550.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                ...
                <p>LB E★Silhouette WORKS Ferrari 458 GT Rear Wing</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$8,640.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                ...
                <p>LB E★Works Nissan GT-R R35 Type 2 Body Kit</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$20,690.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">FERRARI</p>
                <p>LB E★Works Ferrari 458 Rear Wing Ver.1</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$8,700.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">SUBARU</p>
                <p>LB E★Nation Subaru BRZ (ZD8) Rear GT Wing Ver.1</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$2,530.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">NISSAN</p>
                <p>LB E★Works Nissan GT-R R35 Type 2 Hood </p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$1,620.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">TOYOTA</p>
                <p>LB E★Works Toyota Supra (A90) Bonnet Hood </p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$3,080.00</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">INFINITI</p>
                <p>LB E★Nation Infiniti Q50 Front Bumper with Diffuser</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$1,540.00 -</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">FERRARI</p>
                <p>LB E★WORKS Ferrari 348 Body Kit</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$12,650.00</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">FERRARI</p>
                <p>LB E★WORKS Ferrari F355 Rear Wing</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$2,200.00</p>
          ...
          <div className="w-72 h-[420px] bg-white p-5 relative shadow-md border-1">
            ...
            <div className="pt-4 text-2xl">
              <div className="font-Oswald">
                <p className="text-gray-700 text-lg font-semibold">DODGE</p>
                <p>LB E★WORKS Dodge Challenger Body Kit</p>
              </div>
              <div className="flex font-Oswald pt-3">
                <div>
                  <p>$4,800.00 -</p>
